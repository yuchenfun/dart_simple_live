...
(() => {
  ...
  if (!isIframe) {
    ...
    while (node && node !== document.body) {
      ...
      if (hasStatus && rect.width > 0 && rect.height > 0 && rect.width <= 720 && rect.height <= 760) { card = node; break; }
  ...
  style.textContent = `
    ...
    [data-simple-live-login-card="true"], [data-simple-live-login-card="true"] * { visibility: visible !important; }
    [data-simple-live-login-card="true"] { position: fixed !important; left: 50% !important; top: 50% !important;
      transform: translate(-50%, -50%) !important; width: min(90vw, 560px) !important; max-height: 90vh !important;
      overflow: auto !important; box-sizing: border-box !important; }
    [data-simple-live-login-qr="true"] { aspect-ratio: 1 / 1 !important; object-fit: contain !important;
      width: min(60vmin, 360px) !important; height: auto !important; max-width: 100% !important; margin: auto !important; }
    iframe[data-simple-live-login-qr="true"] { width: min(90vw, 560px) !important; height: min(90vh, 680px) !important;
      aspect-ratio: auto !important; object-fit: contain !important; border: 0 !important; }
  `;
...
''';
  ...
  Future<void> _startSession(InAppWebViewController? controller,
      {required bool loadPage}) async {
    _pollTimer?.cancel();
    _checkInFlight = null;
    final generation = ++_generation;
    _completed = false;
